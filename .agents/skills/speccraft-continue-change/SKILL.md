---
name: speccraft-continue-change
description: Continue working on an SpecCraft change by creating the next artifact. Use when the user wants to progress their change, create the next artifact, or continue their workflow.
...
1. **Select the change**
   ...
   Always announce: "Using change: <name>" and how to override (e.g., `/speccraft-continue-change <other>`).
