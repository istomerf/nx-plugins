---
name: speccraft-new-change
description: Start a new SpecCraft change using the experimental artifact workflow. Use when the user wants to create a new feature, fix, or modification with a structured step-by-step approach.
