...
This is now injected into every artifact SpecCraft generates for this project. Run /speccraft-bootstrap again later if the codebase changes enough to be worth re-scanning.
```
